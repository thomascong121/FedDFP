...
model_address = {
    ...
    'resnet50': '/scratch/iq24/cc0395/FedDDG/model/FExtractor/resnet50-19c8e357.pth',
...
def resnet50_baseline(pretrained=False, extra_block=False):
    ...
    if pretrained:
        model = load_pretrained_weights_locally(model, 'resnet50',map_location=torch.device('cuda' if torch.cuda.is_available() else 'cpu'))
    return model
...
def load_pretrained_weights_locally(model, model_name, map_location=None):
    ...
    if model_name == 'resnet50':
        pretrained_dict = torch.load('/scratch/iq24/cc0395/FedDDG/model/FExtractor/resnet50-19c8e357.pth'
